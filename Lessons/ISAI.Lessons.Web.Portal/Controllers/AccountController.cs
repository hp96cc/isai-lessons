...
using ISAI.Lessons.Web.Portal.Models;

namespace ISAI.Lessons.Web.Portal.Controllers
{
    [Authorize]
    public class AccountController : BaseAuthroizationController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    return LoginSuccessRedirect(returnUrl);
        ...
        public ActionResult LoginSuccessRedirect(string returnUrl)
        {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ActivateAccount(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = await UserManager.FindByNameAsync(model.Email);
                ...
                {
                    // Don't reveal that the user does not exist or is not confirmed
                    return View("ActivateAccountConfirmation");
                }
        ...
        // GET: /Account/ForgotPasswordConfirmation
        [AllowAnonymous]
        public ActionResult ActivateAccountConfirmation()
        {
            return View();
        }
